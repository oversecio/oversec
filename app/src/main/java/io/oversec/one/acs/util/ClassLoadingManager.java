...
public class ClassLoadingManager {
    ...
    public Class<?> loadOrGetCachedClass(Context context, CharSequence className,
        ...
        if (TextUtils.isEmpty(className)) {
            Ln.d("Missing class name. Failed to load class.");
            return null;
        }
        ...
        if (TextUtils.isEmpty(packageName)) {
            ...
            if (lastDotIndex < 0) {
                Ln.d("Missing package name. Failed to load class: %s",
                        className);
                return null;
            }
        ...
        try {
            ...
            Ln.e("Error encountered. Failed to load outside class: %s",
                    classNameStr);
        }
        ...
        Ln.d("Failed to load class: %s", classNameStr);
